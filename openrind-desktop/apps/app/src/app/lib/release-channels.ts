...
export const STABLE_UPDATER_ENDPOINT =
  "https://github.com/openrind/openrind-shell/releases/latest/download/latest.json";

/** Alpha channel's Tauri updater manifest URL (macOS-only, rolling). */
export const ALPHA_UPDATER_ENDPOINT =
  "https://github.com/openrind/openrind-shell/releases/download/alpha-macos-latest/latest.json";
