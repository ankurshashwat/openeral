...
If you want to improve an existing translation, start in [`apps/app/src/i18n/locales`](https://github.com/openrind/openrind-shell/tree/dev/apps/app/src/i18n/locales).
...
If you want to follow broader localization work, language requests, or upcoming improvements, check the [i18n roadmap](https://github.com/openrind/openrind-shell/issues/1385).
